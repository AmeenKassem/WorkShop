...
public interface IStoreRepo {
    ...
    // void checkToAddManager(int storeID, int ownerID, int newOwnerId) throws
    // Exception;
    // void AddOwnershipToStore(int storeID, int ownerID, int newOwnerId) throws
    // Exception;
    // void DeleteOwnershipFromStore(int storeID, int ownerID, int OwnerToDelete)
    // throws Exception;
    // void AddManagerToStore(int storeID, int ownerId, int managerId) throws
    // Exception;
    // public void changePermissions(int ownerId, int managerId, int storeID,
