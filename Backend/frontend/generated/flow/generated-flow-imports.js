...
import $cssFromFile_0 from 'Frontend/Theme/homePageTheme.css?inline';

injectGlobalCss($cssFromFile_0.toString(), 'CSSImport end', document);
import $cssFromFile_1 from 'Frontend/Theme/loginTheme.css?inline';

injectGlobalCss($cssFromFile_1.toString(), 'CSSImport end', document);
import $cssFromFile_2 from 'Frontend/Theme/main-layout.css?inline';

injectGlobalCss($cssFromFile_2.toString(), 'CSSImport end', document);
import $cssFromFile_3 from 'Frontend/Theme/My-Cart.css?inline';

injectGlobalCss($cssFromFile_3.toString(), 'CSSImport end', document);
import $cssFromFile_4 from 'Frontend/Theme/myStoresTheme.css?inline';

injectGlobalCss($cssFromFile_4.toString(), 'CSSImport end', document);
import $cssFromFile_5 from 'Frontend/Theme/purchaseTheme.css?inline';

injectGlobalCss($cssFromFile_5.toString(), 'CSSImport end', document);
import $cssFromFile_6 from 'Frontend/Theme/registerTheme.css?inline';
...
import 'Frontend/notification.js';
