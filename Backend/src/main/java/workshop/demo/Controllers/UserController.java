...
public class UserController {
    ...
    public UserController(
        ...
        this.adminHandler = new AdminHandler(orderRepo, storeRepo, userRepo, authRepo);
        this.userSuspensionService = new UserSuspensionService(userSuspensionRepo, userRepo, authRepo);
        this.userService = new UserService(userRepo, authRepo, stockRepo, adminInitilizer, adminHandler, storeRepo);
    }
