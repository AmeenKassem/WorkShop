...
public class DatabaseCleaner {
    ...
    public void wipeDatabase() {
        ...
        sqlBuilder.append("""
                                 ...
                                 ALTER TABLE participation_in_random NOCHECK CONSTRAINT ALL;
                ALTER TABLE random NOCHECK CONSTRAINT ALL;

                DELETE FROM participation_in_random;
                DELETE FROM random;

                ALTER TABLE participation_in_random CHECK CONSTRAINT ALL;
                ALTER TABLE random CHECK CONSTRAINT ALL;
