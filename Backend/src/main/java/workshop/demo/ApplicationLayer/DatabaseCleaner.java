...
DELETE FROM dbo.[single_bid];       -- 🔥 delete single_bid before bid
DELETE FROM dbo.[bid];              -- 🔥 delete bid before active_purcheses
...
DELETE FROM dbo.[active_purcheses]; -- 🔥 only now safe
