...
//    public UserJpaRepository mockUserRepo = Mockito.mock(UserJpaRepository.class);
//    public UserSuspensionJpaRepository mockSusRepo = Mockito.mock(UserSuspensionJpaRepository.class);
//    public GuestJpaRepository mockGuestRepo = Mockito.mock(GuestJpaRepository.class);
//
//
//    public IStoreRepoDB mockStoreRepo = Mockito.mock(IStoreRepoDB.class);
...
//        userService = new UserService(mockUserRepo,mockAuthRepo,mockStockRepo,new AdminInitilizer("123321"),mockGuestRepo,mockStoreRepo);
...
//        //purchaseService = new PurchaseService(mockAuthRepo, mockStockRepo, mockStoreRepo, mockUserRepo,mockPurchaseRepo, mockOrderRepo, mockPay, mockSupply, mockSusRepo);
