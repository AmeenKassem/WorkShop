...
//     private final UserService userService = new UserService(userRepo, authRepo, new StockRepository(), adminInitilizer);
...
//         suspensionService.suspendRegisteredUser(userId, 2, token1); // 2 seconds
...
//         suspensionService.suspendGuestUser(guestId, 2, token1);
...
//         suspensionService.suspendRegisteredUser(userId, 5, token1);
//         Assertions.assertTrue(suspensionService.isUserSuspended(userId));

//         suspensionService.pauseSuspension(userId, token1);
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId));

//         Thread.sleep(1000); // while paused, should not expire

//         suspensionService.resumeSuspension(userId, token1);
//         Assertions.assertTrue(suspensionService.isUserSuspended(userId));

//         Thread.sleep(5100); // wait full 5 seconds post-resume
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId));
//     }
...
//         suspensionService.suspendRegisteredUser(userId, 2, token1);
//         Assertions.assertTrue(suspensionService.isUserSuspended(userId));

//         suspensionService.pauseSuspension(userId, token1);
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId));

//         Thread.sleep(2500); // let "time pass", should NOT expire while paused
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId));

//         suspensionService.resumeSuspension(userId, token1);
//         Assertions.assertTrue(suspensionService.isUserSuspended(userId));

//         Thread.sleep(2500); // after resume
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId));
//     }
...
//         suspensionService.suspendRegisteredUser(10, 2, token1); // wrong userId
//         Assertions.assertFalse(suspensionService.isUserSuspended(userId),
...
//         // Set admin with WRONG key
//         userService.setAdmin(token1, "wrong_key", 2);
