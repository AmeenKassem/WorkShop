...
// === Case 4: newManager already exists and is a manager ===
    ...
    void testEquals_SameReference() {
        UserSpecialItemCart cart = new UserSpecialItemCart(1, 2, 3, SpecialType.BID,"laptop");
    ...
    void testEquals_DifferentStoreId() {
        UserSpecialItemCart c1 = new UserSpecialItemCart(1, 2, 3, SpecialType.BID,"laptop");
        UserSpecialItemCart c2 = new UserSpecialItemCart(99, 2, 3, SpecialType.BID,"laptop");
    ...
    void testEquals_DifferentSpecialId() {
        UserSpecialItemCart c1 = new UserSpecialItemCart(1, 2, 3, SpecialType.BID,"laptop");
        UserSpecialItemCart c2 = new UserSpecialItemCart(1, 99, 3, SpecialType.BID,"laptop");
        assertFalse(c1.equals(c2));
    }
    ...
    void testEquals_DifferentType() {
        UserSpecialItemCart c1 = new UserSpecialItemCart(1, 2, 3, SpecialType.BID,"laptop");
        UserSpecialItemCart c2 = new UserSpecialItemCart(1, 2, 3, SpecialType.Auction,"laptop");
        assertFalse(c1.equals(c2));
    }

    @Test
    void testEquals_ExactMatch() {
        UserSpecialItemCart c1 = new UserSpecialItemCart(1, 2, 3, SpecialType.Random,"laptop");
        UserSpecialItemCart c2 = new UserSpecialItemCart(1, 2, 999, SpecialType.Random,"laptop"); // bidId ignored
