...
UserSuspensionRepo suspensionRepo = new UserSuspensionRepo();
   ...
   Encoder    encoder = new Encoder();
     ...
     UserSuspensionService  suspensionService = new UserSuspensionService(suspensionRepo, userRepo, authRepo);
      UserService userService = new UserService(userRepo, authRepo, stockRepository,adminInitilizer);
 ...
 @BeforeEach
    void setup() throws Exception {
       ...
       userService = new UserService(userRepo, authRepo, stockRepository,adminInitilizer);
