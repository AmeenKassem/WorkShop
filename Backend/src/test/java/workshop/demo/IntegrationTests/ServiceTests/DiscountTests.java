...
public class DiscountTests {
        ...
        void or_discount_store_condition_applies() throws Exception {
                ...
                storeService.addDiscountToStore(storeId, NOToken, orDTO);
        ...
        void and_discount_all_conditions_match() throws Exception {
                ...
                CreateDiscountDTO d1 = new CreateDiscountDTO("CATEGORY", 0.10, CreateDiscountDTO.Type.VISIBLE,
                                "CATEGORY:ELECTRONICS", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO d2 = new CreateDiscountDTO("TOTAL", 0.10, CreateDiscountDTO.Type.VISIBLE,
                                "TOTAL>3000", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO d3 = new CreateDiscountDTO("QUANTITY", 0.10, CreateDiscountDTO.Type.VISIBLE,
                                "QUANTITY>1", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO d4 = new CreateDiscountDTO("ITEM", 0.10, CreateDiscountDTO.Type.VISIBLE,
                                "ITEM:" + itemId, CreateDiscountDTO.Logic.SINGLE, null);

                // CreateDiscountDTO leaf = new CreateDiscountDTO("30% full match", 0.30,
                // CreateDiscountDTO.Type.VISIBLE, null, CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO andDTO = new CreateDiscountDTO("AND Match", 0.0, CreateDiscountDTO.Type.VISIBLE, null,
                                CreateDiscountDTO.Logic.AND, List.of(d1, d2, d3, d4));
        ...
        void and_discount_one_condition_fails() throws Exception {
                ...
                CreateDiscountDTO d1 = new CreateDiscountDTO("Good CATEGORY", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                "CATEGORY:ELECTRONICS", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO d2 = new CreateDiscountDTO("Fail QUANTITY", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                "QUANTITY>10", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO leaf = new CreateDiscountDTO("25% inner", 0.25, CreateDiscountDTO.Type.VISIBLE, null,
                                CreateDiscountDTO.Logic.SINGLE, null);

                CreateDiscountDTO andDTO = new CreateDiscountDTO("AND Partial", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                null, CreateDiscountDTO.Logic.AND, List.of(d1, d2, leaf));
        ...
        void and_discount_only_one_condition() throws Exception {
                ...
                CreateDiscountDTO d1 = new CreateDiscountDTO("QUANTITY", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                "QUANTITY>2", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO leaf = new CreateDiscountDTO("10% on bulk", 0.10, CreateDiscountDTO.Type.VISIBLE,
                                null, CreateDiscountDTO.Logic.SINGLE, null);

                CreateDiscountDTO andDTO = new CreateDiscountDTO("AND One", 0.0, CreateDiscountDTO.Type.VISIBLE, null,
                                CreateDiscountDTO.Logic.AND, List.of(d1, leaf));
        ...
        void and_discount_none_match() throws Exception {
                ...
                CreateDiscountDTO d1 = new CreateDiscountDTO("Bad TOTAL", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                "TOTAL>9000", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO d2 = new CreateDiscountDTO("Bad ITEM", 0.0, CreateDiscountDTO.Type.VISIBLE,
                                "ITEM:9999", CreateDiscountDTO.Logic.SINGLE, null);
                CreateDiscountDTO leaf = new CreateDiscountDTO("50% off never", 0.50, CreateDiscountDTO.Type.VISIBLE,
                                null, CreateDiscountDTO.Logic.SINGLE, null);

                CreateDiscountDTO andDTO = new CreateDiscountDTO("AND none", 0.0, CreateDiscountDTO.Type.VISIBLE, null,
                                CreateDiscountDTO.Logic.AND, List.of(d1, d2, leaf));
        ...
        void testRemoveDiscountFromStore_Success() throws Exception {
                ...
                userService.addToUserCart(NGToken, itemStoreDTO, 2); // 2 * 2000 = 4000
                ReceiptDTO[] receipts1 = purchaseService.buyGuestCart(NGToken, PaymentDetails.testPayment(),
                                SupplyDetails.getTestDetails());
                ...
                ReceiptDTO[] receipts2 = purchaseService.buyGuestCart(NGToken, PaymentDetails.testPayment(),
                                SupplyDetails.getTestDetails());
