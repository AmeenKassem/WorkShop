...
public class DiscountTests {
    ...
    void setup() throws Exception {
        ...
        // activePurcheses.setProductToRandom(NOToken, productId, 1, 2000, createdStoreId, 5000);
        // activePurcheses.setProductToAuction(NOToken, createdStoreId, productId, 1, 1000, 2);
    ...
    void single_discount_category_condition() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, dto.getName(), dto.getPercent(), dto.getType(), dto.getCondition(),
    ...
    void single_discount_total_condition() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "15% off for expensive carts", 0.15,
        ...
        ReceiptDTO[] receipts = purchaseService.buyRegisteredCart(NGToken, PaymentDetails.testPayment(), SupplyDetails.getTestDetails());
    ...
    void single_discount_quantity_condition() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "20% off for bulk buys", 0.20,
    ...
    void single_discount_store_condition_matches() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "10% for store", 0.10,
    ...
    void buy_SINGLE_discount_fail_wrongCategory() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "10% off HOME", 0.10,
    ...
    void buy_SINGLE_discount_fail_quantityTooLow() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "5% off on 10+ items", 0.05,
    ...
    void buy_SINGLE_discount_fail_totalTooLow() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "15% off expensive carts", 0.15,
    ...
    void buy_SINGLE_discount_fail_wrongStore() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, "10% off wrong store", 0.10,
    ...
    void or_discount_store_condition_applies() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, d1.getName(), d1.getPercent(), d1.getType(),
                d1.getCondition(), d1.getLogic(), new String[0]);
        storeService.addDiscountToStore(createdStoreId, NOToken, d2.getName(), d2.getPercent(), d2.getType(),
                d2.getCondition(), d2.getLogic(), new String[0]);
        storeService.addDiscountToStore(createdStoreId, NOToken, orDTO.getName(), orDTO.getPercent(), orDTO.getType(),
    ...
    void and_discount_store_and_category_match() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, d2.getName(), d2.getPercent(), d2.getType(),
                d2.getCondition(), d2.getLogic(), new String[0]);
        storeService.addDiscountToStore(createdStoreId, NOToken, d3.getName(), d3.getPercent(), d3.getType(),
                d3.getCondition(), d3.getLogic(), new String[0]);

        storeService.addDiscountToStore(createdStoreId, NOToken, andDTO.getName(), andDTO.getPercent(), andDTO.getType(),
...
//   CreateDiscountDTO leaf = new CreateDiscountDTO("30% full match", 0.30, CreateDiscountDTO.Type.VISIBLE, null, CreateDiscountDTO.Logic.SINGLE, null);
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, d4.getName(), d4.getPercent(), d4.getType(),
    ...
    void xor_discount_store_only_applies() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, xorDTO.getName(), xorDTO.getPercent(), xorDTO.getType(),
    ...
    void max_discount_store_vs_category_higher_applies() throws Exception {
        ...
        storeService.addDiscountToStore(createdStoreId, NOToken, maxDTO.getName(), maxDTO.getPercent(), maxDTO.getType(),
    ...
    void testRemoveDiscountFromStore_UserSuspended() throws Exception {
        suspensionService.suspendRegisteredUser(authRepo.getUserId(NOToken), 2,Admin);
        UIException ex = assertThrows(UIException.class, () -> {
