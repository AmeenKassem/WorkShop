...
void and_discount_all_conditions_match() throws Exception {
    ...
    CreateDiscountDTO d1 = new CreateDiscountDTO("CATEGORY", 0.0, CreateDiscountDTO.Type.VISIBLE, "CATEGORY:ELECTRONICS", CreateDiscountDTO.Logic.SINGLE, null);
    CreateDiscountDTO d2 = new CreateDiscountDTO("TOTAL", 0.0, CreateDiscountDTO.Type.VISIBLE, "TOTAL>3000", CreateDiscountDTO.Logic.SINGLE, null);
    CreateDiscountDTO d3 = new CreateDiscountDTO("QUANTITY", 0.0, CreateDiscountDTO.Type.VISIBLE, "QUANTITY>1", CreateDiscountDTO.Logic.SINGLE, null);
    CreateDiscountDTO d4 = new CreateDiscountDTO("ITEM", 0.0, CreateDiscountDTO.Type.VISIBLE, "ITEM:" + itemId, CreateDiscountDTO.Logic.SINGLE, null);
    ...
    CreateDiscountDTO andDTO = new CreateDiscountDTO("AND Match", 0.0, CreateDiscountDTO.Type.VISIBLE, null, CreateDiscountDTO.Logic.AND, List.of(d1, d2, d3, d4, leaf));

    storeService.addDiscountToStore(1, NOToken, andDTO);
    userService.addToUserCart(NGToken, itemStoreDTO, 2);

    ReceiptDTO[] receipts = purchaseService.buyGuestCart(NGToken, PaymentDetails.testPayment(), SupplyDetails.getTestDetails());
    assertEquals(2800, receipts[0].getFinalPrice()); // 30% off
}
