...
public class PurchaseTests {
    ...
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].bids[0].getStatus().equals(Status.AUCTION_PENDING));
    //
    // Thread.sleep(500);
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].status.equals(AuctionStatus.IN_PROGRESS));
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].bids[0].getStatus().equals(Status.AUCTION_PENDING));
    //
    // Thread.sleep(500);
    ...
    //
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].status.equals(AuctionStatus.FINISH));
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].bids[0].getStatus().equals(Status.AUCTION_WON));
    //
    ...
    // needed
    // ReceiptDTO[] receipts = purchaseService.finalizeSpecialCart(NGToken,
    ...
    // 1)[0].status.equals(AuctionStatus.FINISH));
    // assertTrue(stockService.getAllAuctions(NOToken,
    // 1)[0].bids[0].getStatus().equals(Status.AUCTION_LOSED));
    //
    // PaymentDetails paymentDetails = PaymentDetails.testPayment(); // fill if
    // needed
    // SupplyDetails supplyDetails = SupplyDetails.getTestDetails(); // fill if
    ...
    //
    //
    // assertTrue(stockService.getAllRandomInStore(NOToken,
    // 1)[0].participations.length==1);
    // assertTrue(stockService.getAllRandomInStore(NOToken,
    // 1)[0].participations[0].won());
    // // assertTrue(stockService.getAllRandomInStore(NOToken,
    // 1)[0].winner.userId==4);
    //
    //
    ...
    //
    // assertTrue(stockService.getAllRandomInStore(NOToken,
    // 1)[0].participations.length==2);
    // assertFalse(stockService.getAllRandomInStore(NOToken,
    // 1)[0].participations[0].won());
    // // assertTrue(stockService.getAllRandomInStore(NOToken,
    // 1)[0].winner.userId==4);
    //
