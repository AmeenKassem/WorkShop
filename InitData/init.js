...
async function generateGuestToken() {
  const response = await axios.get(
    "http://localhost:8080/api/users/generateGuest"
  );
...
const BASE_URL_STORE = "http://localhost:8080/stock";
...
const products = [
  ...
  ["OnePlus 11", "ELECTRONICS", "Fast and smooth Android smartphone", "phone"],
  [
    "Xiaomi 13 Pro",
    "ELECTRONICS",
...
// loginUsers();
const tokenUSer =
  "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ7XCJ1c2VyTmFtZVwiOlwidXNlcjFcIixcImlkXCI6Mn0iLCJpYXQiOjE3NDc4OTg1NTgsImV4cCI6MTc0NzkwMjE1OH0.ih3_ecnHi7XdjypvP83h_THs2_mSNkDTqGuW00iKxnQ";
addStore(tokenUSer)
